---
title: "Exploring Data Joins - will be post"
...
Interestingly, the `data.table` approach allows us to explicitly tell the join that it is ordered already.
...
The results below show the joining of the 80MB data sets, with ordered and unordered numeric ID variables.

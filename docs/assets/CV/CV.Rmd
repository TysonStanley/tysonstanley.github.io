...
httr::set_config(httr::user_agent("Mozilla/5.0 (compatible; R scholar package)"))
your.id <- "UWdXXEoAAAAJ" # This is your google scholar ID
profile <- get_profile(your.id)
pubs <- get_publications(your.id, cstart = 0, pagesize = 100, flush = TRUE)
...
\begin{tabular}{l|p{8cm}}
 ...
 &\footnotesize{\emph{Dissertation: Marginal Mediation Analysis: A New Framework for Interpretable Mediated Effects}}\\
 \multicolumn{2}{c}{} \\
...
\indent \hspace*{.1in} \small\textbf{Professional Practice Associate Professor}, Utah State University \hfill 2026-Present
\newline \hspace*{.6in} \emph{Department of Data Analytics and Information Systems in the Jon M. Huntsman School of Business}
\newline \hspace*{.6in} \emph{Teach data analytics with an emphasis on healthcare analytics}
\newline \hspace*{.6in} \emph{Project Mentor in the \href{https://huntsman.usu.edu/asc/}{Analytics Solutions Center}}


\indent \hspace*{.1in} \small\textbf{Manager Advanced Analytics}, Highmark Health \hfill 2022-2026
...
\indent \hspace*{.1in} \small\textbf{Research Scientist}, Department of Communication Disorders, Utah State University \hfill 2022-2026
...
\indent \hspace*{.1in} \small\textsc{Research:} Development and testing of open source tools for healthcare analytics

\indent \hspace*{.1in} \textsc{Teaching:} Healthcare analytics, health services research, R and Python programming
...
\* \emph{Signifies Two First Authors}

...
Buntrock, M.S., Barker, B.A., Gurries, M.M., & \textbf{Barrett, T.S.} (in press). The effect of talker familiarity on sentence recognition accuracy in complex noise. \emph{Experimental Psychology}. \img{osf_data.png}{https://osf.io/d4zar/}\img{osf_materials.png}{https://osf.io/d4zar/}

*Tannahill, H.S., Fargo, J.D., \textbf{Barrett, T.S.}, & Blais, R.K. (in press). Gender as a moderator of the association of military sexual trauma and posttraumatic stress symptoms. \emph{Journal of Clinical Psychology}.

Borrie, S.A., Lansford, K.L., & \textbf{Barrett, T.S.} (in press). A Clinical Advantage: Experience informs recognition and adaptation to a novel talker with dysarthria. \emph{Journal of Speech, Language, and Hearing Research}. \img{osf_data.png}{https://osf.io/prf95}\img{osf_materials.png}{https://osf.io/prf95}

Lubold, N., Willi, M.M., Borrie, S.A., \textbf{Barrett, T.S.}, & Berisha, V. (in press). Healthy communication partners modify their speech when conversing with individuals with Parkinson’s disease. \emph{Journal of Speech, Language, and Hearing Research}.

Muñoz, K., San Miguel, G., \textbf{Barrett, T.S.}, Kasin, C., Baughman, K., Reynolds, B., Ritter, C., Larsen, M., Whicker, J.J., & Twohig, M.P. (2021). eHealth Parent Education for Hearing Aid Management: A Pilot Randomized Control Trial. \emph{International Journal of Audiology.} doi: 10.1080/14992027.2021.1886354. \img{osf_data.png}{https://osf.io/y5698/}\img{osf_materials.png}{https://osf.io/y5698/}

Hirsch, M.E., Lansford, K.L., \textbf{Barrett, T.S.}, & Borrie, S.A. (2021). Generalized Learning of Dysarthric Speech between Male and Female Talkers. \emph{Journal of Speech, Language, and Hearing Research}. doi: 10.1044/2020_JSLHR-20-00313.

Knollhoff, S., Borrie, S.A., \textbf{Barrett, T.S.}, & Searl, J.P. (2021). Listener Impressions of Alaryngeal Communication Modalities. \emph{International Journal of Speech-Language Pathology}. doi: 10.1080/17549507.2020.1849400 \img{osf_data.png}{https://osf.io/qgkm2/}\img{osf_materials.png}{https://osf.io/qgkm2/}

*Crapo, J.S., \textbf{Barrett, T.S.}, Bradford, K., Miller, J.A., & Higginbotham, B.J. (2020). Couple relationship education outcomes predicted by family life stage and traditionality. \emph{Contemporary Family Therapy, 42}, 422-435. doi: 10.1007/s10591-020-09541-x.
...
Barney, J., \textbf{Barrett, T.S.}, Lensgrav-Benson, T., Quakenbush, B., Twohig, M. (under review). Confirmatory Factor Analysis and Measurement Invariance of the Cognitive Fusion Questionnaire-Body Image in a Clinical Eating Disorder Sample. \emph{European Eating Disorders Review}.
...
Smith, B.M., Barney, J.L., Ong, C.W., \textbf{Barrett, T.S.}, Levin, M.E., & Twohig, M.P. (under review). Physiological, behavioral, and self-report outcomes of acceptance and regulation approaches to exposures for intrusive thoughts. \emph{BRAT}.

Sulzer, S., Prevedel, S., \textbf{Barrett, T.S.}, Voss, M.W., Manning, C., Madden, E.F. (under review). Professional Education to Reduce Provider Stigma toward Harm Reduction and Pharmacotherapy. \emph{Drugs: Education, Prevention \& Policy}.

Emery, C., Morgan, R., \& \textbf{Barrett, T.S.} (under review). The Effects of Joint Training on Career and Technical Education and Special Education Professionals. \emph{Career Development and Transition for Exceptional Individuals}.

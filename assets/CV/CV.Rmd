...
\textbf{Barrett, T.S.}, Wylie, A., Vogel, B., Sanghavi, K., Raspa, M., Aveni, K.P., Tullis, K., Caggana, M, White, K.R., \& Bodurtha, J. (2018). Where Do We Go From Here? The Need for Genetic Referrals in Patients who are Deaf or Hard of Hearing: Findings from a Regional Survey. \emph{Journal of Early Hearing Detection and Intervention, 3}(1), 36-53.

\vspace{-4pt}
\forceindent $-$ Code and Data: [doi: 10.17605/OSF.IO/8THWF](https://osf.io/8thwf/)
...
Borrie, S.A., \textbf{Barrett, T.S.}, Willi, M., \& Berisha, V. (in revision). Syncing up for a good conversation: A Multidimensional framework for quantifying entrainment. \emph{JSHLR}.
...
\textbf{Barrett, T.S.} \& Lockhart, G. (in revision). Efficient Exploration of Many Variables and Interactions Using Regularized Regression. \emph{Prevention Science}.

...
<!-- Name -->
\hspace{.08in}\huge\textsc{Tyson S. Barrett, PhD} \hfill \footnotesize Updated: Nov 26, 2018
\normalsize
\vspace{10pt}
...
<!--  Paste the following into the table below once the Masters starts
\textsc{M.S. Communication Sciences} & \emph{In Progress} \\
...
Borrie, S.A., \textbf{Barrett, T.S.}, Yoho, S.E. (in revision). Autoscore: An open-source automated tool for scoring listener perception of speech. \emph{Journal of Acoustical Society of America.} \img{osf_materials.png}{https://github.com/autoscore/autoscore} 

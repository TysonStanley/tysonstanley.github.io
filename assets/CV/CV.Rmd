...
\newline \hspace*{.6in} \emph{Lead of Statistical and Methodological Team}
\newline \hspace*{.6in} \emph{Care Analytics in Entreprise Data and Analytics}
...
\newline \hspace*{.6in} \emph{Administrator of SONA Systems}
\newline \hspace*{.6in} \emph{Administrator of REDCap}
...
\indent \hspace*{.1in} \small\textsc{Primary:} Applied Methodology in the Health and Disability Disciplines

\indent \hspace*{.1in} \textsc{Secondary:} Accessible Methodology Using R Programming
...
\emph{A causal framework of communicative participation in people with} \hfill July 1, 2023 -- June 30, 2028 \newline \emph{Parkinson's disease}

\indent \hspace{.25in} Borrie, S. A. (PI), \textbf{Barrett, T. S. (Co-I)}, Visar, B. (Co-I), & Liss, J. (Co-I). Sponsored by NIH/NIDCD	R01DC020713-01A1. Current Status: Funded. $2,329,452.

\vspace{8pt}

\emph{Speaker and listener strategies to improve intelligibility in} \hfill July 1, 2023 -- December 31, 2024 \newline \emph{Parkinson's disease}

\indent \hspace{.25in} Lansford, K. L. (PI), Borrie, S. A. (Co-I), & \textbf{Barrett, T. S. (Co-I)}. Sponsored by the Parkinson's Foundation (Impact Award). Current Status: Funded. $150,000.

\vspace{8pt}

\emph{Necessary Education and eXperiential Training} \hfill Sept 1, 2020 -- August 30, 2024 \newline \emph{for Upcoming Para-professionals (NEXT-UP)}
...
\emph{Bridging Harm Reduction and Wellness for Tribal and Rural} \hfill Sept 1, 2020 --	Aug 31, 2023 \newline
\emph{Areas of the Intermountain West} 

\indent \hspace{.25in} Sulzer, S. (PI), Prevedel, S., Chapoose, M., Madden, E., \textbf{Barrett, T. S. (Co-I)}, Keady, T., Peatross, J., DasGupta, D., Fullenkamp, N., & Zaman, K. Sponsored by SAMHSA, H79TI083267. Current Status: Funded. $1,099,997.
...
\indent \hspace{.25in} Leopold, S. (PI), Borrie, S. A. (Co-I), & \textbf{Barrett, T. S. (Co-I)}. Sponsored by NIH/NIDCD, 1R21DC018641-01. Current Status: Completed. $430,000.

\vspace{8pt}

\emph{Perceptual training for improved intelligibility of dysarthric speech} \hfill July 1, 2020 -- June 30, 2022

\indent \hspace{.25in} Borrie, S. A. (PI), Lansford, K. (PI), & \textbf{Barrett, T. S. (Co-I)}. Sponsored by NIH/NIDCD	1R21DC018867-01. Current Status: Completed. $420,000.

\vspace{8pt}

\emph{Psychological flexibility in adults with ASD:} \hfill Sept 1, 2021 -- Aug 31, 2022 \newline
\emph{Psychological distress in the context of \newline COVID-19} 

\indent \hspace{.25in} Aller, T. B. (PI), \textbf{Barrett, T. S. (Co-I)}, McClain Verdoes, M. (Co-I), \& Levin, M. (Co-I). Sponsored by National Research Consortium on Mental Health in Intellectual and Developmental Disabilities. Current Status: Completed. $10,000.

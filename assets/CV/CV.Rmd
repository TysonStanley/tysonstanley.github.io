...
<!-- Name -->
\hspace{.08in}\huge\textsc{Tyson S. Barrett, PhD} \hfill \footnotesize Updated: April 8, 2019
\normalsize
\vspace{10pt}
...
\begin{tabular}{rl}
    ...
    \textsc{Citations:}   & `r profile$total_cites` (since 2015) \\
    \textsc{H Index:}     & `r profile$h_index` (since 2015) 
\end{tabular}
...
\indent \hspace*{.1in} \small\textbf{Center for Open Science Ambassador } \img{cos_logo.png}{https://osf.io/gkjbx} \hfill 2019-Present
...
\hrule
\vspace{-1pt}
\footnotesize \hspace{4pt} * Denotes that I was the methodologist or data scientist on the proposal
...
*Hoopes, K. (Principal), Smith, J. (Co-Principal), Sulzer, S. (Co-Principal), Israelsen, C. E. (Co-Principal), Blais, R. (Co-Principal), Bressel, E. (Co-Principal), Mason, J. (Co- Principal), \textbf{Barrett, T.S.} (Co-Principal), "Equine Human Interaction with Veterans", Sponsored by USU Extension Grants Program, Utah State University, (May 1, 2019 - December 31, 2019). $11,640. Current Status: Funded
...
*Smith, B.M., Ong, C.W., \textbf{Barrett, T.S.}, Bluett, E.J., Slocum, T.A., \& Twohig, M.P. (in press). Longitudinal effects of a 2-year meditation and Buddhism program on well-being, quality of life, and valued living. \emph{Mindfulness}. \img{osf_data.png}{https://osf.io/64awp/}\img{osf_materials.png}{https://osf.io/64awp/}

*Long, E., \textbf{Barrett, T.S.}, \& Lockhart, G. (in press). Chronic health conditions and adolescent friendships: Perspectives for social network analysis. \emph{International Journal of Adolescent Medicine and Health}.
...
\textbf{Barrett, T.S.} \& Lockhart, G. (2018). Efficient Exploration of Many Variables and Interactions Using Regularized Regression. \emph{Prevention Science}, 1-10. doi: 10.1007/s11121-018-0963-9. \img{osf_data.png}{https://osf.io/kat82/}\img{osf_materials.png}{https://osf.io/kat82/} 
...
\textbf{Barrett, T.S.}, Borrie, S.A., & Yoho, S.E. (under review). Autoscore: An R package for scoring listener transcripts for research and the clinic. \emph{Journal of the Acoustical Society of America}. \img{osf_data.png}{https://github.com/autoscore/autoscore}\img{osf_materials.png}{https://github.com/autoscore/autoscore}

\textbf{Barrett, T.S.}, Cruz, R.A., \& Lockhart, G. (under review). Marginal Mediation Analysis: A Practical Statistical Framework for Interpretable Mediated Effects. \emph{Behavior Research Methods}. \img{osf_data.png}{https://osf.io/753kc/}\img{osf_materials.png}{https://osf.io/753kc/}
...
Ong, C. W., Lee, E. B., Krafft, J., Terry, C. L. \textbf{Barrett, T.S.}, Levin, M. E., & Twohig, M. P. (under review). A Randomized Controlled Trial of Acceptance and Commitment Therapy for Clinical Perfectionism. \emph{Journal of Obsessive-Compulsive and Related Disorders}.

Larson, A.L., \textbf{Barrett, T.S.} \& McConnell, S.R. (under review). Exploring Early Childhood Language Environments: A Comparison of Language Use and Exposure in the Home and Childcare Settings. \emph{American Journal of Speech-Language Pathology}.
...
\textbf{Barrett, T.S.} (2019). dissertateUSU. URL: github.com/tysonstanley/dissertateUSU. R package version 0.1.1. \img{dissertateUSU_hex.jpg}{https://github.com/TysonStanley/dissertateUSU}

\textbf{Barrett, T.S.} (2019). connectivity. URL: github.com/tysonstanley/connectivity. R package version 0.1.0. \img{connectivity_hex.jpg}{https://github.com/TysonStanley/connectivity}

\textbf{Barrett, T.S.} (2019). rjasa. URL: github.com/tysonstanley/rjasa. R package version 0.1.0.

\textbf{Barrett, T.S.}, Borrie, S.A., & Yoho, S.E. (2019). autoscore. URL: github.com/autoscore/autoscore. R package version 0.4.0. \img{autoscore_hex.jpg}{https://github.com/autoscore/autoscore}

\textbf{Barrett, T.S.} (2018). MarginalMediation: Marginal Mediation Analysis. URL: tysonbarrett.com/MarginalMediation. R package version 0.7.0. \img{mma_hex.jpg}{https://github.com/TysonStanley/MarginalMediation}

\textbf{Barrett, T.S.}, Brignone., E. \& Laxman, D. (2018) furniture: Furniture for Quantitative Researchers. URL: tysonbarrett.com/furniture. R package version 1.9.0. \img{furniture_hex.jpg}{https://github.com/TysonStanley/furniture}
...
```{r citation_fig, fig.width=8, fig.height=2, echo = FALSE, warning = FALSE, message = FALSE}
ggplot(citations, aes(year, cites, color = year)) +
  ...
  labs(x = "Year", 
       y = "Citation Count\n(by Year)",
       caption = "Note: Data for citations in 2019 only until April.") +
  theme_classic() +
...
Vázquez, A.L., Chou, T., Navarro, C., **Barrett, T.S.**, Villodas, M.T., & Domenech Rodríguez, M.M. (2019, November). Machine learning predicts caregiver perceived need for and utilization of adolescent counseling services for youth at-risk for maltreatment. In M. D. Hetzel-Riggin (Chair). Addressing violence, abuse, and trauma throughout the socioecological model. Symposium submitted for presentation at the Association for Behavioral and Cognitive Therapies, Atlanta, GA.

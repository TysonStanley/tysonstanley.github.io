...
Lansford, K., Borrie, S.A., & \textbf{Barrett, T.S.}. (in press). Regularity matters: Unpredictable speech degradation inhibits adaptation to dysarthric speech
\emph{Journal of Speech, Language, and Hearing Research}.

*Ong, C.W., Barney, J.L., \textbf{Barrett, T.S.}, Lee, E.B., Levin, M.E., & Twohig, M.P. (in press). The role of psychological inflexibility and self-compassion in acceptance and commitment therapy for clinical perfectionism. \emph{Journal of Contextual Behavioral Science}.

*Ong, C.W., Lee, E. B., Krafft, J., Terry, C.L., \textbf{Barrett, T.S.}, Levin, M.E., & Twohig, M.P. (in press). A randomized controlled trial of acceptance and commitment therapy for clinical perfectionism. \emph{Journal of Obsessive-Compulsive and Related Disorders}.    
...
Borrie, S.A., \textbf{Barrett, T.S.}, Berisha, V. (in revision). Characterizing conversational entrainment in dysarthria using a multidimensional, clinically meaningful approach. \emph{Journal of Acoustical Society of America}. \img{osf_data.png}{https://osf.io/ktg5q/}\img{osf_materials.png}{https://osf.io/ktg5q/}

*Larson, A.L., \textbf{Barrett, T.S.} \& McConnell, S.R. (in revision). Exploring Early Childhood Language Environments: A Comparison of Language Use and Exposure in the Home and Childcare Settings. \emph{American Journal of Speech-Language Pathology}.

*Nelson, L.H., Anderson, K., Whicker, J., \textbf{Barrett, T.S.}, Muñoz, K. \& White, K. (under review). Classroom Listening Experiences of Students who are DHH using LIFE-R. \emph{Language, Speech, and Hearing Services in Schools}.

\textbf{Barrett, T.S.} (under review). Six Reasons to Consider Using R in Psychological Research. \emph{Advances in Methods and Practices in Psychological Science}. \img{osf_data.png}{https://osf.io/436d7/}\img{osf_materials.png}{https://osf.io/436d7/}
...
\hrule
\vspace{3pt}
\footnotesize \hspace{4pt} Pre-prints yet to be published in a peer-reviewed journal \normalsize
...
Lubold, N. Borrie, S.A., \textbf{Barrett, T.S.}, Willi, M., & Berisha, V. (accepted). Do Conversational Partners Entrain on Articulatory Precision? \emph{Proceedings of INTERSPEECH 2019.} Paper number 1786, 1–5. (three reviewers, 50\% acceptance rate).
...
ggplot(citations, aes(year, cites, color = year)) +
  ...
  labs(x = "Year", 
       y = "Citation Count\n(by Year)",
       caption = paste("Note: Data for citations in", year,"only until", month)) +
  theme_classic() +
...
<!--
Topic Area: Motor Speech Disorders Across the Lifespan
Session Number: 9364 Poster Board 630
Title: Gamified Perceptual Learning of Dysarthric Speech
Session Format: Poster
Day: Saturday, November 23, 2019
Time: 12:30 PM ? 2:00 PM
Authors: Samantha Budge (PRESENTING AUTHOR: Author who will be presenting), Stephanie Borrie (AUTHOR ONLY: Author, but will NOT be presenting), Tyson Barrett (AUTHOR ONLY: Author, but will NOT be presenting), Sarah Yoho (AUTHOR ONLY: Author, but will NOT be presenting), Rochelle-Noreen Vargas (AUTHOR ONLY: Author, but will NOT be presenting), Kaitlin Lansford (AUTHOR ONLY: Author, but will NOT be presenting)

Topic Area: Motor Speech Disorders Across the Lifespan
Session Number: 9075 Poster Board 341
Title: Familiarization of Dysarthric Speech: Generalization Between Speakers of Different Sex
Session Format: Poster
Day: Saturday, November 23, 2019
Time: 8:00 AM ? 9:30 AM
Authors: Megan Hirsch (PRESENTING AUTHOR: Author who will be presenting), Kaitlin Lansford (PRESENTING AUTHOR: Author who will be presenting), Stephanie Borrie (AUTHOR ONLY: Author, but will NOT be presenting), Tyson Barrett (AUTHOR ONLY: Author, but will NOT be presenting)
-->

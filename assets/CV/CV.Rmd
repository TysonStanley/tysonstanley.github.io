...
\newline \hspace*{.6in} \emph{Lead of Statistical and Methodological Consultant Team}
\newline \hspace*{.6in} \emph{Blended Care Data Research and Analytics}

\indent \hspace*{.1in} \small\textbf{Adjunct Professor}, Department of Psychology, Utah State University \hfill 2022-Present
...
\emph{Bridging Harm Reduction and Wellness for Tribal} \hfill Sept 1, 2020 -	Aug 31, 2023 \newline
\emph{and Rural Areas of the Intermountain West} 
...
\indent \hspace{.25in} \emph{This project is designed to provide opioid addiction treatment services for tribal and rural areas. The evaluation of the project is ongoing throughout the administration of the services.}

...
<!--
1R21DC018641-01 ($430,000)	Sarah Leopold (PI)	04/01/2020-03/31/2023
NIH/NIDCD		
Application of Ideal Binary Masking to Disordered Speech
The major goal of this project is to utilizes an established signal processing technique to investigate its potential application to overcome speech-in-noise difficulties for listeners understanding dysarthric speech.
...
*Larson, A.L., \textbf{Barrett, T.S.} \& McConnell, S.R. (in press). Exploring Early Childhood Language Environments: A Comparison of Language Use and Exposure in the Home and Childcare Settings. \emph{Language, Speech, and Hearing Services in Schools}.
...
Knollhoff, S. & \textbf{Barrett, T.S.} (under review). Listener Impressions of Alaryngeal Communication Modalities. \emph{International Journal of Speech-Language Pathology}.
...
Buntrock, M., Gurries, M. \textbf{Barrett, T.S.}, Barker, B. (under review). The effect of talker familiarity on sentence recognition accuracy in complex noise. \emph{Language and Speech}.

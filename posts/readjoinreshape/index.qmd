...
description: "It is a common problem in the social sciences where we have several disparate data files that all have information we want combined into one beautiful, complete data set. But how to do this?"
date: 2017-06-06
author: Tyson S. Barrett
categories: [data wrangling, reproducibility]
---

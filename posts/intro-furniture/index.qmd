...
description: "This has been updated to work with the most recent version of the `furniture` package."
date: 2017-08-01
...
![Table in Forest](/assets/images/table_in_forest.jpg)
...
I'll demonstrate, on data from the 2011-2012 release of the [NHANES][NHANES] data, how we can explore the relationship between demographic characteristics and dietary and other health behaviors in children and adolescents. I have provided the data [here](/assets/Data/NHANES.zip).

...
description: "With the advent of a more cohesive and complete `dtplyr`, I’ve been wanting to write about how it can be used with `tidyfast` to use the syntax of the `tidyverse` while relying on the speed and efficiency of `data.table`. This workflow is…"
date: 2019-12-03
author: Tyson S. Barrett
categories: [data.table, data wrangling, packages]
---
...
![](/assets/RMD/2019-11-15-workflow_dtplyr_tidyfast_files/figure-markdown_strict/unnamed-chunk-14-1.png)

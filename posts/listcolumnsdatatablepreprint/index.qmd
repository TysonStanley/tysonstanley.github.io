...
description: "I posted a new preprint named \"List-columns in data.table: Nesting and unnesting data tables and vectors\" in *PsyArXiv*. It can be downloaded here. It has been submitted to the *R Journal* (Oct 2019) so updates to the manuscript may follow…"
date: 2019-10-04
author: Tyson S. Barrett
categories: [data.table, data wrangling, reproducibility]
---
